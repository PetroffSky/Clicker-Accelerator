...
class ClickApp(tk.Tk):
    def __init__(self):
        ...
        btn_select_file.pack(padx=70, pady=10)
...
def main():
    click = ClickApp()
    click.title('CSTC')
    label = ttk.Label(text='Clickermann Script Time Corrector')
    label.pack()
    click.geometry("350x100+760+500")  # Устанавливаем размеры окна и его положение на экране. БЕЗ ПРОБЕЛОВ!
    click.mainloop()
